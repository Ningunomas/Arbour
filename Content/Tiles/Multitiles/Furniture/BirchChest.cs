...
public class BirchChest : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<BirchChestBlock>());
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        {
            bool hasName = Main.chest[chest].name.Length > 0;
            player.cursorItemIconText = hasName ? Main.chest[chest].name : Language.GetTextValue("Mods.Arbour.Tiles.BirchChest.MapEntry");

            if (!hasName)
            {
                player.cursorItemIconID = ModContent.ItemType<BirchChestBlock>();
